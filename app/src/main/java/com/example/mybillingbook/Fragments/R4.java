 ...
 * Use the {@link R4#newInstance} factory method to
...
public class R4 extends Fragment {
     ...
     * @return A new instance of fragment R4.
     */
    // TODO: Rename and change types and number of parameters
    public static R4 newInstance(String param1, String param2) {
        R4 fragment = new R4();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_r4, container, false);


        imageView=view.findViewById(R.id.imagefour);
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists())
                {
                    ...
                    Picasso.get().load(runningImages.getImagefour()).placeholder(R.drawable.placeholder).into(imageView);
                }
            }
